...
(function() {
  ...
  UnobtrusiveFlash.showFlashMessage = function(message, options) {
    ...
    var $flash = $('<div class="alert alert-'+options.type+' alert-dismissible fade '+showClass+'"><button type="button" class="close" data-dismiss="alert">&times;</button>'+message+'</div>');
